...
/**
 * Strip the link-building fields (`baseUrl`,`param`,`query`,`hash`,`offset`,
 * `prevPage`,`nextPage`) from a `buildPagination()` result, leaving just the
 * JSON pagination-meta shape API responses should carry.
 */
export const toPaginationMeta = ({ page, pageSize, totalCount, totalPages, hasPrev, hasNext }) => ({
  page,
  pageSize,
  totalCount,
  totalPages,
